...
<!DOCTYPE html>
	...
	<meta name="author" content=" hilal tasolar" />
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<h2>Hilal Taşolar</h2>
			<p>Bilgisayar Mühendisliği öğrencisiyim. Web ve Mobil uygulama geliştirmekteyim.</p>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry single-entry">
			...
			<!-- 	<span class="fh5co-meta animate-box"><a href="single.html">NOT</a></span>  -->
				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					<div class="row">
						<div class="col-lg-8 cp-r animate-box">
							<textarea class="form form-control" id="note_detail" style="height:400px;widyh:100%"placeholder="İçerik"></textarea>
