...
public class NoteDAO {
	...
	public ArrayList<Note> getAll(Long user_id){
		Query query= sessionFactory.getCurrentSession().createQuery("FROM Note WHERE user_id=:user_id").setLong("user_id", user_id);
		return (ArrayList<Note>) query.getResultList();
	}
