...
<!DOCTYPE html>
	...
	<!-- not ekleme kısmı -->
	<div style="position:fixed; width:100%; height:100vh;background-color: #555555;z-index:-1"></div>
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<ul class="fh5co-social">
				<li><a href="logout">Çıkış Yap  <i class="icon-door"></i></a></li> <!-- çıkış yappdüzelt -->
